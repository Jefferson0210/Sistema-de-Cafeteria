...
public class CafeteriaApp {
    ...
    public static void main(String[] args) {
        SpringApplication.run(CafeteriaApp.class, args);
    }
    ...
    class WebConfig implements WebMvcConfigurer {
        ...
        private com.cafeteria.app.service.RateLimitService rateLimitService;
        ...
        public void addInterceptors(org.springframework.web.servlet.config.annotation.InterceptorRegistry registry) {
            ...
            registry.addInterceptor(new com.cafeteria.app.ratelimit.RateLimitInterceptor(rateLimitService))
                    .addPathPatterns(
