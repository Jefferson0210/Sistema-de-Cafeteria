...
import com.cafeteria.app.dto.OAuth2LoginDto;
...
import com.cafeteria.app.service.GoogleIdTokenService;
...
import com.cafeteria.app.service.RolService;
...
public class AutenticacionWS {
    ...
    private String generarToken(Usuario u) {
        ...
        return Jwts.builder()
                ...
                .claim(com.cafeteria.app.JWTAuthorizationFilter.PERMISOS, extraerRoles(u))
                .setIssuedAt(new Date())
                .setExpiration(new Date(System.currentTimeMillis() + expMs))
                .signWith(SignatureAlgorithm.HS256, com.cafeteria.app.JWTAuthorizationFilter.KEY_APP.getBytes())
                .compact();
    }
